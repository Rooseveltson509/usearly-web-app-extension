...
interface PopupSuggestCoeurConfirm {
    onClose: () => void;
}
const SuggestConfirm: React.FC<PopupSuggestCoeurConfirm> = ({ onClose }: { onClose: () => void }) => {
    return (
        <div className="category-popup-overlay">
            <div className="category-popup">
                ...
                <div className="popup-content">
                    <h1 className='h1Title'>Suggestion d'idée envoyée avec succès, merci! </h1>
                    ...
                    <p className='desc-animation'> Pour créativité !</p>
                </div>
