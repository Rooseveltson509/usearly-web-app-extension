...
import { isUserAuthenticated, login, logout } from '../services/AuthService';
...
const DraggableFloatingMenu: React.FC<FloatingMenuProps> = ({ x, y, onCommentClick, onCaptureClick, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <div className="tooltip-container">
                <svg className='svg-icon' onClick={onCaptureClick} id="commentIcon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="tooltip-container">
                <svg className='svg-icon' onClick={onCommentClick} id="heartIcon" width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <div className="tooltip-container">
                    <svg className='svg-icon' onClick={onCommentClick} id="magicIcon" width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
