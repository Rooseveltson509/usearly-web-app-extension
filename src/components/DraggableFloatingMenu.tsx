...
const DraggableFloatingMenu: React.FC<FloatingMenuProps> = ({ x, y, onCommentClick, onCaptureClick, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <div>
                <svg className='svg-icon' onClick={onCaptureClick} id="commentIcon" width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                <svg className='svg-icon' onClick={onCommentClick} id="heartIcon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
